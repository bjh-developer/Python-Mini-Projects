...
def process():
    ...
    count = 0
    names = ['Maglina Bte Ismail', 'Nurashikin Bte Mohamed Said', 'Loh Lai Yeow Daniel', 'Mohamed Almie Bin Mohamed Mazlan', 'Seng Mun Kong', 'Fu Chun Yu', 'Teo Lian Kiat', 'Hoe Ju Jin Junie', 'Lin Qinrong Michelle', 'Radiana Raza Ali', 'Siti Sarah Binte Mamat', 'Wong Ching-Yi Chesed', 'Wong Jing Xian Adeline', 'S N Muraledharan Naidu', 'Ho Si Ye Tammie', 'Khoo Sin Min Ambert', 'Rossenah Bte Kamis', 'Chen Jianwei Michael', 'Jonathan Yap Boon Kwang', 'Edmund Oh', 'Mohamed Ibrahim Bin Aris', 'Ong Lai Wei', 'Kee Chwee Hoon', 'Ong Siew Kim', 'Phang Yuh Koon', 'Shang Nan Nan', 'Wang Feng', 'Chan Xin Min', 'Chang Qi Yin Zoe Ruth', 'Chen Minhua', 'Tan Yen Lin', 'Qi Yan Ping', 'Fan Lijun', 'Om Wen Jie', 'Teo Yao Lu', 'Wang Wen', 'Wang Xiao', 'Wong Peng Kwee', 'Wu I-Husan', 'Yao Yadang', 'Azmi Bin Abdul Wahid', 'See Sze Ping', 'Yee Ren Ping Robbie', 'Ahmad Hashikin M B Mohd Latiff', 'Stefanie Michaela Tang Xiu Hua', 'Norashikin Bte Mohamed', 'Nurdiyana Binte Hamzah Lee', 'Surayah Bte Mohamed Anwar', 'Angela Yap', 'Fiona Chee Liee Horng', 'Ponni D/O Agoram', 'Sarah Ng Y L', 'Diana Angullia', 'Soh Guat Ee', 'Loh Siew Hua', 'Yeoh Zheng Sheng Alexandre Paul', 'Roziah Bte Ismail', 'Long Lay Na', 'Chua Chor Loon', 'Lim Wen Xi Alvin', 'Charmaine Loo', 'Joanna Tan', 'Veronica Tan', 'Claudia Chew Han Ngee ', 'Han Hua Yi', 'Tze Hui Yi', 'Khairunnisa Bte Yahya', 'Koh Rui Ling', 'Lai Han Wei', 'Shobitha D/O Vasudevan', 'Christin Pang', 'Kek Yee Ann', 'Quek Beng Hong', 'Toh Lay Hoon', 'Muhammad Vub Ismail', 'Ng See Khee', 'Lim Lymin Joel', 'Lin Guojing', 'Tan Han Kiang', 'Wu De Rui', 'Lee Shu Ling Charlene Judith', 'Yee Kok Kheong ', 'Tan Pei Lee Jasmine', 'Peggy Yap', 'Michelle Foo', 'Char Wai Han Cassandra', 'Lim Chow Syan ', 'Tan Sek Jiau', 'Teo Tan Li Jaclyn', 'Yong Kian Yi Rachel', 'Michelle Chew', 'Chia Chooong Kwok Kelvin', 'Adlin Bte Idris', 'Alvin Ang Ban Leong', 'Ang Joo Seng Jason', 'Foo Kok Wei', 'Gan Choo Ming Lawrence', 'Jalaluddin Bin Hezan', 'Lam Tse Sun Samson', 'Ng Sin Wee Benny', 'Tay Han Seng Clement', 'Chow Yee Teng', 'Elizabeth So', 'Jasmine Fok', 'Tan Jo Hsuan', 'Anisa Bte Mohamad Ali', 'Ong Shiau Chuen', 'Ho Yi Han', 'Jun Liyana Binte Amin', 'Ong Xin Hui', 'Tan Seow Lan', 'Tay Hui Min']
